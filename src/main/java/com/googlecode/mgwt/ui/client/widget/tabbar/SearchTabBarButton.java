...
public class SearchTabBarButton extends TabBarButton {
   ...
   */
	public SearchTabBarButton(TabBarCss css) {
		super(css, MGWT.getOsDetection().isGecko() || MGWT.getOsDetection().isIOs() || MGWT.getOsDetection().isDesktop() ? MGWTStyle.getTheme().getMGWTClientBundle().tabBarSearchImage() : null);
		setText("Search");
	}
